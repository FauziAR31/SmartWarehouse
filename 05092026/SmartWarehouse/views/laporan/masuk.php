...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 fw-bold text-dark mb-1">
            <i class="fas fa-arrow-circle-down text-success me-2"></i><?php echo $reportTitle; ?>
        </h1>
            ...
            <table class="table table-hover align-middle mb-0" id="laporanTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><code class="text-success fw-bold small"><?php echo htmlspecialchars($r['transaction_number']); ?></code></td>
                            <td class="small">
                            ...
                            <td class="text-center fw-bold text-success"><?php echo number_format($r['qty']); ?></td>
                            ...
                            <td class="small"><?php echo htmlspecialchars($r['supplier_name'] ?? '-'); ?></td>
                ...
                <tfoot class="table-light fw-bold">
                    <tr>
                        ...
                        <td class="text-center text-success"><?php echo number_format(array_sum(array_column($rows, 'qty'))); ?></td>
                        <td colspan="5"></td>
                    </tr>
                </tfoot>
                <?php endif; ?>
