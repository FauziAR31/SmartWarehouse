<?php
$reportType  = 'pemindahan';
$reportTitle = 'Laporan Pemindahan Barang';
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 fw-bold text-dark mb-1">
            <i class="fas fa-exchange-alt text-warning me-2"></i><?php echo $reportTitle; ?>
        </h1>
            ...
            <table class="table table-hover align-middle mb-0" id="laporanTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td><code class="text-warning fw-bold small"><?php echo htmlspecialchars($r['transaction_number']); ?></code></td>
                            <td class="small">
                            ...
                            <td class="text-center fw-bold text-warning"><?php echo number_format($r['qty']); ?></td>
                            <td class="text-center"><span class="badge bg-light text-dark border"><?php echo htmlspecialchars($r['unit']); ?></span></td>
                            <td class="small">
                                <code class="text-danger"><?php echo htmlspecialchars($r['lokasi_asal_kode']); ?></code><br>
                                <small class="text-muted"><?php echo htmlspecialchars($r['lokasi_asal_nama']); ?></small>
                            </td>
                            <td class="small">
                                <code class="text-success"><?php echo htmlspecialchars($r['lokasi_tujuan_kode'] ?? '-'); ?></code><br>
                                <small class="text-muted"><?php echo htmlspecialchars($r['lokasi_tujuan_nama'] ?? ''); ?></small>
                            </td>
                ...
                <tfoot class="table-light fw-bold">
                    <tr>
                        ...
                        <td class="text-center text-warning"><?php echo number_format(array_sum(array_column($rows, 'qty'))); ?></td>
                        <td colspan="5"></td>
                    </tr>
                </tfoot>
                <?php endif; ?>
